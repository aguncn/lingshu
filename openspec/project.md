...
## 设计权威参考
- `docs/灵枢_技术方案与架构设计.md`：架构、数据模型、接口契约、AgentScope 集成
- `docs/灵枢_开发计划与OpenSpec提案任务书.md`：10 个 P0 提案、每提案 ~10 任务、验收命令
- `docs/灵枢_开发执行手册.md`：环境、CLAUDE.md、命令流、apply/verify/archive
